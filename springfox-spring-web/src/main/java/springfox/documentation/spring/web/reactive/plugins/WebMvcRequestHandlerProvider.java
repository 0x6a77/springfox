 ...
 *
 */
package springfox.documentation.spring.web.reactive.plugins;
...
import springfox.documentation.spring.web.reactive.WebReactiveRequestHandler;
...
public class WebMvcRequestHandlerProvider implements RequestHandlerProvider {
  ...
  private Function<Map.Entry<RequestMappingInfo, HandlerMethod>, RequestHandler> toRequestHandler() {
    return new Function<Map.Entry<RequestMappingInfo, HandlerMethod>, RequestHandler>() {
      @Override
      public WebReactiveRequestHandler apply(Map.Entry<RequestMappingInfo, HandlerMethod> input) {
        return new WebReactiveRequestHandler(
            methodResolver,
            input.getKey(),
            input.getValue());
      }
